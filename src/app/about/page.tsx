  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center px-102 py-16">
        ...
        <p className="text-md text-gray-700 mb-8 text-center font-lato">
          The project explores UI components and patterns, done differently.<br/>
          A collection of interactive and flagerbasting UI experiments and components which I find cool, and build overtime. 
          </p>  

          <p className="text-md text-gray-700 mb-6 mt-6 text-center font-lato">
          I hope you explore, learn, and get inspired by delightful web interactions, built with love and some Nextjs and TailwindCSS ;) <br></br> 
          <span className="font-bold text-pink-800 underline">TW:</span> you might get the itch of these interactions and play them in your mind before sleep every night (I most certainly do🫢).    
        </p>
        <Link
          ref={buttonRef}
          href="/"
